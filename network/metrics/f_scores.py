...
class FBetaScore(tf.keras.metrics.Metric):
    ...
    Args:
        ...
        sparse: Indicates if labels are in form of indices instead of one hot vector
    ...
    # TODO: Add sample_weight support, currently it is ignored during calculations.
    def update_state(self, y_true, y_pred, sample_weight=None):
        ...
        if self.sparse:
            y_true = tf.squeeze(tf.one_hot(y_true, self.num_classes, dtype=tf.int32), axis=1)
...
class F1Score(FBetaScore):
    ...
    Args:
        ...
        threshold: Elements of `y_pred` above threshold are
            ...
            None, the argmax is converted to 1, and the rest 0.
        sparse: indicates if labels are in form of indices instead of one hot vectors
    ...
    def __init__(self,
        ...
        super(F1Score, self).__init__(
            num_classes, average, 1.0, threshold, name=name, dtype=dtype, sparse=sparse)
